...
[latest-windows-download-link]: https://github.com/Amund211/prism/releases/download/v1.11.0/prism-v1.11.0-windows.exe
[latest-mac-download-link]: https://github.com/Amund211/prism/releases/download/v1.11.0/prism-v1.11.0-mac.dmg
[latest-linux-download-link]: https://github.com/Amund211/prism/releases/download/v1.11.0/prism-v1.11.0-linux
...
The overlay uses the [Urchin API](https://urchin.ws) (not associated) to highlight known cheaters and snipers.

## Qualities
- Display known cheaters and snipers (using Urchin API)
