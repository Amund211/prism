...
sort_test_cases: tuple[tuple[list[Player], set[str], ColumnName, list[Player]], ...] = (
    ...
    (
        ...
        set(),
        "username",
        [players["carl"], players["carl_jr_jr"], players["chad"], players["joe"]],
    ),
    (
        [players["joe"], players["chad"], players["carl"], players["carl_jr_jr"]],
        set(),
    ...
    (
        ...
        set(),
        "wlr",
        [players["chad"], players["carl_jr_jr"], players["carl"], players["joe"]],
    ),
    (
        [players["joe"], players["chad"], players["carl"], players["carl_jr_jr"]],
        set(),
        "winstreak",
        [players["carl"], players["joe"], players["chad"], players["carl_jr_jr"]],
    ),
)
